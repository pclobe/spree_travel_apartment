### This is the data
rates = ['start_date', 'end_date', 'price_per_person']
contexts = ['destination', 'start_date', 'end_date', 'persons']
variants = ['apartment_type']
...
Spree::ProductType.where(:name => 'apartment').first_or_create(
